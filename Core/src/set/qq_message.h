...
namespace qq{
    ...
    public:
         ...
         * @return
         */
        SendQQMessage(uint64 to_uin,uint64 msg_id,int face,MessageType type,std::vector<std::pair<ContentMessageType,std::string>> msg);

        ~SendQQMessage();

    private:
        StructSendQQMessage message;
    ...
    public:
         ...
         * @return
         */
        SendQQMessage &SetFontName(std::string fontName);
        /**
         * 设置字体大小
         * @param size
         * @return
         */
        SendQQMessage &SetFontSize(int size);
        /**
         * 设置字体颜色
         * @param fontColor
         * @return
         */
        SendQQMessage &SetFontColor(std::string fontColor);
        /**
         * 设置pessionid
         * @param psessionid
         * @return
         */
        SendQQMessage &SetPsessionid(std::string psessionid);
        /**
         * 获取要发送的消息类型
         * @return
         */
    ...
    public:
         ...
         * @return
         */
        const MessageContent GetQQMessage()const;
        /**
         * 当消息为群组或者讨论组时，表示群组id
         * @return
         */
